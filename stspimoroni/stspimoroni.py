...
class StsPimoroni  (Node):
    '''StsPiMoroni  node suitable for a RPi robot with pimoroni explorer hat pro
    based on Wheelie code.
    ...
    def __init__(self, name,
                 wheel_diameter=.049, wheel_base=0.11,
        ...
        self._rightWheel = explorerhat.motor.two 
        self._leftWheel = explorerhat.motor.one 
    ...
    def _forward(self, speed=100):
        self._rightWheel.forwards(speed)
        self._leftWheel.forwards(speed)

    def _reverse(self, speed=100):
        self._rightWheel.backwards(speed)
        self._leftWheel.backwards(speed)
    ...
    def _set_motor_speeds(self):
        ...
        #
        self._rightWheel.speed(right_percentage)
        self._leftWheel.speed(left_percentage)
